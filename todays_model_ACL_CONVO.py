...
#         aspect_senti=aspect_senti.permute(0,1,3,2)                                #(16,7,160,2)
        
#         i_p_senti = F.softmax(self.imp_score_senti,dim=0).to(device)
#         i_p_senti = i_p_senti.unsqueeze(0).unsqueeze(0)                            #(1,1,2,1)
        
#         aspect_senti=torch.matmul(aspect_senti,i_p_senti).squeeze(-1).to(device)   #(16,7,160)
#         aspect_senti=aspect_senti.permute(0,2,1)                                   #(16,160,7)
#         i_p = F.softmax(self.imp_score,dim=0).to(device)
#         i_p = i_p.unsqueeze(0)                                                     #(1,7,1)
        
#         e=torch.matmul(aspect_senti,i_p).squeeze(-1).to(device)                    #(16,160)
